...
- APAC is the top-performing market based on sales.
- Sales increased consistently from 2011 to 2014.
- The Consumer segment generated the highest sales among the three segments.
- The dashboard allows users to interactively filter results by year and market.
